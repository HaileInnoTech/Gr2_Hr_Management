        ...
        <div>
          ...
          <div class="flex">
            ...
            <input
              ...
              type="password"
              id="password"
              class="rounded-e-lg bg-gray-50 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5 border border-gray-600"
