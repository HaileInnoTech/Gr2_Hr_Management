    ...
    >
      <div class="p-5">
        <div>
          ...
          <div class="flex">
            <span
              class="inline-flex items-center px-3 text-sm text-gray-500 bg-gray-50 rounded-e- rounded-s-md dark:text-gray-400 border-y border-l border-gray-600"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
            ...
            <input
              ...
              type="password"
              id="password"
              class="rounded-e-lg bg-gray-50 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 border border-gray-600"
